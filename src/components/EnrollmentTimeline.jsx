...
export default function EnrollmentTimeline() {
  ...
  const steps = [
    ['Inscripción', 'Completa los formularios de inscripción y de pago. Adjunta DPI o pasaporte de ambos padres y envíalos a ventas3@stem-care.com o al WhatsApp 5702-9736.'],
    ['Contrato y kit', 'Stem Care registra la recolección en espera y entrega el contrato y el kit. En el interior del país, coordina la entrega por Cargo Expreso.'],
